...
3. Includes facebook, twitter and linkedin profiles in microformat (schema / snippet view / google structure data) 
4. And also can add their geo-location details in microformat. 
...
-	In over all reduces the bounce rate. Turns every visitor into unique and frequent user. 


Planned Feature and Reccomended 
-------------------------------- 

Can display a list of authors and users with their social profiles in a page or post. This will serve like a Social Profile cum user directory. 
You can use a existing plugin for now. As we have planned to add this in future release. And that will be within couple of weeks. Also encourage your visitors to register to get listed here. Or lock this content for registered users only. Dont forget to keep a catchy social share buttons on top and bottom of content to get viral. By this you can gain more free traffic.  
...
2. Admin settings for Imageset configutration to the frontend. 
3. Microdata Social profile information and User Geo-Information for user profile settings. 
4. Preview form placed in widget area to the frontend. 
...
3. How the user's configure their social profile? 
